; +------------------------------------------------------------+
; |     OLDSTILE CRACKTRO. CODED BY ALX/BW/XPJ ON 10.2000      |
; +------------------------------------------------------------+
...
PAGE1   DB "                PUMPED !",#0D                  ;1
        DB #0D                                             ;2
        DB " -+ B + R + A + I + N + W + A + V + E +-",#0D  ;3
        DB "                   OF",#0D                     ;4
        DB "        X  -  P  R  O  J  E  C  T",#0D         ;5
        DB #0D                                             ;6
        DB "            BACKS 4 OLD GOOD",#0D              ;7
        DB "           WITH THE GAME FROM",#0D             ;8
        DB #0D                                             ;9
        DB "       ZZZZZZZZZZZZZZZZZZZZZZ 'ZZ       ",#0D  ;A
        DB #0D                                             ;B
        DB "       NNNNNNNNNNNNNNNNNNNNNNNNNN       ",#0D  ;C
        DB "+--------------------------------------+",#0D  ;D
...
PAGE2   DB "*=------------------------------------=*",#0D;1
        ...
        DB #0D                                           ;7
        DEFB "CRACKTRO MUZAK.................MM<M/SAGE",#0D;8
        DB #0D                                           ;9
        DB "GAME CRACKED......................??????",#0D;A
        DEFB "TRAINED, DISKED, PACKED.......ALX/BW/XPJ",#0D;B
        DB #0D                                           ;C
        DB "RELIZE DATE.....................XX.YY.ZZ",#0D;D
        DB "*=------------------------------------=*",#0D;E
...
PAGE5   DB "               LOOK FOR:",#0D                ;1
        DEFB "                +-----+",#0D                 ;2
        DEFB #0D                                           ;3
        DEFB "   SURVIVOR, BLOOD VALLEY, SPY HUTER",#0D    ;4
        DEFB #0D                                           ;5
        DEFB "   MIAMI COBRA,  SABOTEUR COLLECTION",#0D    ;6
        DEFB #0D                                           ;7
        DEFB "      AMAUROTE+, ROGUE TROOPER+++",#0D       ;8
        DEFB #0D                                           ;9
        DEFB "   FOX FIGHTS BACK!, LICENSE TO KILL",#0D    ;A
        DEFB #0D                                           ;B
        DEFB "    PETER PACK-RET,  STAINLESS STEL",#0D     ;C
        DEFB #0D                                           ;D
        DEFB "    CANYON WARRIOR, SLIGHTLY MAGIC+",#0D     ;E


PAGE6   DB "               COMMING SOON:",#0D            ;1
        DEFB "#-------------------------------------#",#0D ;2
        DEFB #0D                                           ;3
        DEFB "COUNTDOWN TO THE DEATH,  CHUBBY CRISTLE",#0D ;4
        DEFB #0D                                           ;5
        DEFB " BUBBLER,  WELL'S FORGO, CYCLONE, XENO",#0D  ;6
        DEFB #0D                                           ;7
        DEFB "    HIGHWAY ENCOUNTER COLLECTION+++",#0D     ;8
        DEFB #0D                                           ;9
        DEFB "    BASKET MASTER+++, PYJAMARAMA+++",#0D     ;A
        DEFB #0D                                           ;B
        DEFB "   BASIL - THE GREAT MOUSE DETECTIVE",#0D    ;C
        DEFB #0D                                           ;D
        DEFB " THE SHADOW OF THE MORDOR  (ADVENTURE)",#0D  ;E
...
PAGE_CH DB "       ALX'S MEGATRAINER (+NN)",#0D
        DB "0. UNLIMIT 0........................NOP",#0D
        DB "1. UNLIMIT 1........................NOP",#0D
        DB "2. UNLIMIT 2........................NOP",#0D
        DB "3. UNLIMIT 3........................NOP",#0D
        DB "4. UNLIMIT 4........................NOP",#0D
        DB "5. UNLIMIT 5........................NOP",#0D
        DB "6. UNLIMIT 6........................NOP",#0D
        DB "7. UNLIMIT 7........................NOP",#0D
        DB "8. UNLIMIT 8........................NOP",#0D
        DB "9. UNLIMIT 9........................NOP",#0D
        DB "Q. UNLIMIT Q........................NOP",#0D
        DB "W. UNLIMIT W........................NOP",#0D
        DB "E. UNLIMIT E........................NOP",#0D
...
LOADER  INCLUDE "LOADRcrk"

MUSIC   INCBIN "MyMusPT2"
